...
<head>
    ...
    <link href="assets/dist/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="header.php">
                ...
                <div class="sidebar-brand-text mx-3">SPK Laptop</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="dtalternatif.php">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item active">
                <a class="nav-link" href="dtpenilaian.php">
                    <i class="fas fa-fw fa-table"></i>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item active">
                <a class="nav-link" href="matrixkeputusan.php">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Matrix Keputusan</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Alif Radifan Piandy</span>
                                <img class="img-profile rounded-circle" src="assets/dist/img/undraw_profile.svg">
                            </a>
